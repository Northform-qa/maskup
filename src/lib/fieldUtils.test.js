...
describe('today date calculation logic', () => {
  ...
  // Real usage relies on the browser's local timezone; tests pass it explicitly
  // so the assertion doesn't depend on the test runner's own timezone.
  function fixedToday(timeZone = TORONTO) {
